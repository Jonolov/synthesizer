...
/***/ function(module, exports, __webpack_require__) {
	...
	var _synth = __webpack_require__(5);
	...
	var _envelopes = __webpack_require__(14);
	...
	Components.Synth = _synth2.default;
	Components.Keyboard = _keyboard2.default;
	Components.Selector = _selector2.default;
	Components.Oscillator = _oscillator2.default;
	Components.Envelopes = _envelopes2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRangeslider = __webpack_require__(7);
	...
	var Synth = function (_React$Component) {
	    ...
	    function Synth(props) {
	        ...
	        _this.startNote = function (note) {
	            ...
	            _this.envelope.triggerAttack();
	        };
	
	        _this.stopNote = function () {
	            _this.setState({
	                playing: false
	            });
	            _this.envelope.triggerRelease();
	        };
	        ...
	        _this.setAttack = function (e) {
	
	            _this.envelope.attack = e;
	        ...
	        _this.setDecay = function (e) {
	
	            _this.envelope.decay = e;
	        ...
	        _this.setSustain = function (e) {
	
	            _this.envelope.sustain = e;
	        ...
	        _this.setRelease = function (e) {
	
	            _this.envelope.release = e;
	        ...
	        _this.envelope = new _tone2.default.AmplitudeEnvelope({
	            attack: _this.state.attack,
	            decay: _this.state.decay,
	            sustain: _this.state.sustain,
	...
	var Volume = function (_React$Component2) {
	    _inherits(Volume, _React$Component2);
	
	    function Volume(props, context) {
	        _classCallCheck(this, Volume);
	
	        var _this2 = _possibleConstructorReturn(this, (Volume.__proto__ || Object.getPrototypeOf(Volume)).call(this, props, context));
	...
	var Detune = function (_React$Component3) {
	    _inherits(Detune, _React$Component3);
	
	    function Detune(props, context) {
	        _classCallCheck(this, Detune);
	
	        var _this3 = _possibleConstructorReturn(this, (Detune.__proto__ || Object.getPrototypeOf(Detune)).call(this, props, context));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rangeslider = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Oscillator = function (_React$Component) {
	    _inherits(Oscillator, _React$Component);
	    ...
	    function Oscillator(props) {
	        ...
	        var env = _this.props.envelope;
	
	        _this.waves = ['sine', 'square', 'triangle', 'sawtooth'];
	
	        _this.tone = new _tone2.default.Oscillator({
	            frequency: _this.props.frequency,
	            type: _this.waves[_this.props.waveform],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Envelopes = function (_React$Component) {
	    _inherits(Envelopes, _React$Component);
	
	    function Envelopes(props, context) {
	        _classCallCheck(this, Envelopes);
	
	        var _this = _possibleConstructorReturn(this, (Envelopes.__proto__ || Object.getPrototypeOf(Envelopes)).call(this, props, context));
	
	        _this.handleAttack = function (value) {
	            _this.setState({
	                attack: value
	            });
	
	            _this.props.onAttackChange(value);
	        };
	
	        _this.handleDecay = function (value) {
	            _this.setState({
	                decay: value
	            });
	
	            _this.props.onDecayChange(value);
	        };
	
	        _this.handleSustain = function (value) {
	            _this.setState({
	                sustain: value
	            });
	
	            _this.props.onSustainChange(value);
	        };
	
	        _this.handleRelease = function (value) {
	            _this.setState({
	                release: value
	            });
	
	            _this.props.onReleaseChange(value);
	        };
	
	        _this.state = {
	            attack: _this.props.attack,
	            decay: _this.props.decay,
	            sustain: _this.props.sustain,
	            release: _this.props.release /** Start value **/
	        };
	        return _this;
	    }
	
	    _createClass(Envelopes, [{
	        key: 'render',
	        value: function render() {
	
	            return _react2.default.createElement(
	                'div',
	                { className: 'synth__envelopes' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'synth__envelope--attack' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'rangeslider__label' },
	                        'Attack'
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'synth__envelope--decay' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'rangeslider__label' },
	                        'Decay'
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'synth__envelope--sustain' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'rangeslider__label' },
	                        'Sustain'
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'synth__envelope--release' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'rangeslider__label' },
	                        'Release'
